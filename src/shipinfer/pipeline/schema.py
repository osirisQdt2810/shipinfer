"""The event this pipeline publishes — the old Kafka contract, extended for ships.
...
class PerceptionEvent:
    ...
    def as_det2mot(self) -> dict[str, Any]:
        ...
        return {
            ...
            "body_feature_vec": [list(o.embedding) for o in people],
        ...
        payload.update(
            {
                ...
                "ship_feature_vec": [list(o.embedding) for o in ships],
