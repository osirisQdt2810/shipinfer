...
grep -E '^(chain |bench: |host cpu:|startup_s|frames_read|frames_dropped|frames_accepted|frames_failed|events_emitted|events_complete|events_incomplete|queue_rejected|collector_|reassembly_us_)' \
