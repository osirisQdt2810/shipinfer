...
this plane prints it too -- and refuses the arm the driver declined, because a requested-and-
unapplied arm is the flag-off arm under another name.
...
class TestTheArmSaysWhatItIs:
    ...
    def test_an_arm_that_applied_to_nothing_is_refused(self, monkeypatch) -> None:
