...
namespace {
    ...
    // Every `setting` key, in written order. All eight or none: a partial set is refused on
    // both planes, because a reader filling the gap from its own default is the thing
